...
<body>
    <div class="store" id="konfirmasi">
        <h4>Informasi Penawaran saya</h4>
        <form action="" method="post">
            ...
            <tr>
                ...
                <th style="padding: 30px;">Alamat Pemilik</th>
                <th style="padding: 30px;">Jumlah / Karung</th>
            ...
            ?>
            <tr>
                <td style="padding: 30px;"><?= $row['kode_produk']; ?></td>
                <td style="padding: 30px;"><?= $row['jenis_produk']; ?></td>
                <td style="padding: 30px;"><?= $row['nama_produk']; ?></td>
                <td style="padding: 30px;"><?= $row['alamat']; ?></td>
                <td style="padding: 30px;"><?= $row['jumlah']; ?></td>
                <td><?php 
                    if ($row['status'] == 0){
                        echo '<span style="color: #F8CB2E;">Menunggu Persetujuan</span>';
                    } else if($row['status'] == 1){
                        echo '<span style="color: #06f044dd;">Telah disetujui</span>';
                    } else{
