            ...
            <tr>
                ...
                <td style="padding: 30px;"><?php 
                    if ($baris['status'] == 0){
                        ...
                        echo '<span style="color: green;">Telah disetujui</span>';
                    } else{
                        echo '<span style="color: red;">Tidak disetujui</span>';
                    }
                ?>
                </td>
                <td style="padding: 30px;" class="setuju">
                    <a href=" setuju.php?id=<?= $baris['id_p']; ?> " class="setujup">Setujui</a>
                    <a href=" tidaksetuju.php?id=<?= $baris['id_p']; ?> " class="setujupp">Tolak</a> 
                </td>
            </tr>
            <?php
                endforeach;
